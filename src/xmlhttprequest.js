...
(function () {
    ...
    try {
      ...
      if (details.headers) {
        for (var prop in details.headers) {
          ...
          if (
            _webRequest.use &&
            (prop.toLowerCase() == "user-agent" ||
              prop.toLowerCase() == "referer")
          ) {
  ...
  Registry.register("xmlhttprequest", {
    run: xmlhttpRequest,
    setWebRequest: setWebRequest,
  });
})();
